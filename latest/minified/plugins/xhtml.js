	...
	var defaultCommandsOverrides = {
		...
		aparat: {
			txtExec: function (caller) {
				...
				SCEditor.command.get('aparat')._dropDown(
					editor,
					caller,
					function (id) {
						editor.insertText(
						         '<embed height="400" width="100%" flashvars="config=http://www.aparat.com/video/video/config/videohash/{id}" allowfullscreen="true" quality="high" name="aparattv" id="aparattv" style="" src="http://www.aparat.com/public/public/player/aparattv" type="application/x-shockwave-flash">'
