...
// instead by creating BBCode tokens like the parser.
	...
	var bbcodes = {
		...
		aparat: {
			...
			html:       '<embed height="400" width="100%" flashvars="config=http://www.aparat.com/video/video/config/videohash/{0}" allowfullscreen="true" quality="high" name="aparattv" id="aparattv" style="" src="http://www.aparat.com/public/public/player/aparattv" type="application/x-shockwave-flash">'
