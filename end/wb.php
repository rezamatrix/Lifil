...
echo $parser->parse($matn['0'])
	...
	->get_html();
                ...
                ?></div></div></div> <div  dir="ltr"><a href="?idb=<?php echo $q12; ?>"  class="btn btn-default"><b>ادامه مطلب</b></a>   </div>
...
*/
              ?>
                 ...
                 <div class="blue">   <a href="profile.php?id=<?php echo $q6; ?>"><img src="<?php echo "img.php?user=$idh2q&name=" . $idh7q; ?>" alt="<?php echo $idh1q; ?>" class="rounded  w-40"> نویسنده:<?php echo $idh1q; ?></a></div>
  <div class="hide">
