...
$ip=getRealIpAddr();
        $chat_id=$activedf;
        if(strlen(chatid($idh,$con))>1){
        $textin=urlencode("ورود جدید به اکانت شما
        ip:$ip
        تاریخ : $time
        ");
...
?>
      ...
      <form name="form" method="post" action="login.php">
        ...
        <center >یا</center>
        <br>
            <a  class="btn primary btn-block p-x-md"     href="register.php">ثبت نام</a>

      </form>
      <div class="alert alert-info fade in" dir="rtl" ><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><br>
<strong>نکات مهم!</strong><br>
1-هرگز رمز عبور خود را به دیگران ندهید<br>
2-ما هیچ وقت به رمز عبور شما نیازی نداریم<br>
3-هیچ وقت از remember pas مرورگر استفاده نکنید<br></div>
</div>
