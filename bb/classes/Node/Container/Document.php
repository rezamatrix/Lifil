...
class Node_Container_Document extends Node_Container
{
	...
	public static function default_bbcodes()
	{
		return array(
			...
			new BBCode('rtl', '<span dir="rtl">%content%</span>'),
			new BBCode('ltr', '<span dir="ltr">%content%</span>'),
			new BBCode('aparat', '<embed height="400" width="100%" flashvars="config=http://www.aparat.com/video/video/config/videohash/%content%" allowfullscreen="true" quality="high" name="aparattv" id="aparattv" style="" src="http://www.aparat.com/public/public/player/aparattv" type="application/x-shockwave-flash">'),
			...
			new BBCode('img', function($content, $attribs, $node)
			{
				...
				return "<a href=\"{$content}\" target=\"_blank\"><img{$attrs} src=\"{$content}\" class=\"img-thumbnail\"/></a>";
			}, BBCode::INLINE_TAG, false, array(), array('text_node'), BBCode::AUTO_DETECT_EXCLUDE_ALL),
