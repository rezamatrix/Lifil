...
<div class="row" >
  ...
  <form action="uploadclinte.php" class="dropzone white">
    <div class="dz-message" ui-jp="dropzone" ui-options="{ url: 'uploadclinte.php' }">
        <h4 class="m-t-lg m-b-md"><img src="../img/drag-and-drop-icon.png" alt=""  width="100%" /></h4>
                ...
                <div class="col-sm-8">
                <div class="box"  dir="rtl">
      <div class="box-header blue" dir="rtl">فایل های آپلود شده</div>   <br>
        <script src="../js/js.js"></script>

             <div class="btn-group m-r container" dir="rtl ">
  ...
  <strong>حذف!</strong> حذف شد.
      ...
      ?>
            ...
            <div  id="txtHint" lang="0"></div> <br>
                      <div>
            <div class="btn-group m-r " dir="ltr">
