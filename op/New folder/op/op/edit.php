...
$rows1 = mysqli_num_rows($news3);
 ...
 $pix5=$pix['4'];
 if(isset($_POST['send'])){
            $post1=htmlspecialchars(mysqli_real_escape_string($con,$_POST['sub']));
           $post2=htmlspecialchars(mysqli_real_escape_string($con,$_POST['matn']));
           $post2aw=htmlspecialchars(mysqli_real_escape_string($con,$_POST['matn2']));
