...
$pass=editblog($reza1,$reza2,$reza4,$reza3,$id,$att,$pic2e,$pic1e,$con)  ;
  ...
  <strong>حذف!</strong> حذف شد.
       ...
       $q7=$blogname['slid'];
        ...
        <img src="<?php echo "../imguser/blog/" . $q7; ?>" alt=""  width="800" height="213"   class="img-rounded"><br>
          تصویر شاخص:<input name="pic1" type="file" class="form-control">  <br>
             <img src="<?php echo "../imguser/blog/" . $q6; ?>" alt=""  width="800" height="213"   class="img-rounded"><br>
