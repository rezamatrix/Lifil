         ...
         @$cartmeli=$eedt['cartmeli'];
               ...
               $pic1e=$rand1."s.".end($pic1) ;
                ...
                @ $fileSize = $_FILES["pic1"]["size"];
                 ...
                 if($fileSize<= 1000000 and mb($con)+$fileSize <= 1073741824)         {
...
else if ($result !== '')
{
    echo "خطا".$result;
     ...
     $ph =$str;
                ...
                if(is_numeric($ph) and strlen($ph)>11){
...
if($sh>0 and !preg_match( "/[:,\\. ^ ? ; & | ' ! . # $ % ^ *( )   € < > \\n\\r\\t\\s]+/", $ir ) and is_numeric($sh)){
  ...
  <strong>موفق بود!</strong>با موفقیت انجام شد
    ...
    <div class="col-md-12 tab-content pos-rlt lt">
        <div class="tab-pane active box" id="tab-1">
        <div class="box-header blue"> پرفایل</div>
        <div class="container">
        <br>
...
<br>
        ...
        <div class="tab-pane box" id="tab-2">
                         <div class="box-header blue">تنظیمات اکانت </div>
        ...
        <div class="tab-pane box" id="tab-3">
            <div class="box-header blue"> وبلاگ و محصولات </div>
           <div class="container">
        ...
        <div class="tab-pane box" id="tab-4">
                         <div class="box-header blue">Api</div>
...
<br>
        ...
        <div class="tab-pane box" id="tab-5">
                         <div class="box-header blue">حساب بانکی </div>
     ...
     $sel=mysqli_query($con,"SELECT *FROM `cart` WHERE `iduser` ='$idusefr' ORDER BY `id` DESC ");
        ...
        <div class="tab-pane box" id="tab-6">
            <div class="box-header blue"> تایید هویت </div>
<br>
            ...
            <div class="row p-5">   <div class="col-sm-4">
                    ...
                    </form> </div>    <?php  } if($phacc==0){   ?>     <div class="col-sm-4">
            ...
            <?php  if($phacc==0){   ?>                                 <form action="" method="POST">
